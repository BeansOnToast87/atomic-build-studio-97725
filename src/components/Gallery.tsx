...
const Gallery = () => {
  const demos = [
    { title: "Pressure Washing Demo", url: "https://demo1.example.com" },
    { title: "Mobile Detailing Demo", url: "https://demo2.example.com" },
    { title: "Trades Template", url: "https://demo3.example.com" }
  ];
          ...
          {demos.map((demo) => (
            ...
            >
              ...
              <Button
                variant="outline"
                size="lg"
                onClick={() => handleDemoClick(demo.title, demo.url)}
